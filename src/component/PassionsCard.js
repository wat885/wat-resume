    ...
    <>
      ...
      >
        ...
        <div className="w-[347px] h-[280px] rounded-2xl m-3.5 shadow-[0_5px_26px_5px_rgba(0,0,0,0.17)] flex flex-col justify-center items-center bg-[#FFFFFF]">
          <div>
            <img src="img/undraw_Wireframing_re_q6k6 1.png" alt="frontend" />
          </div>
        ...
        <div className="w-[347px] h-[280px] rounded-2xl m-3.5 shadow-[0_5px_26px_5px_rgba(0,0,0,0.17)] flex flex-col justify-center items-center bg-[#FFFFFF]">
          <div>
            <img
              src="img/undraw_Detailed_analysis_re_tk6j 1.png"
              alt="frontend"
            />
          </div>
        ...
        <div className="w-[347px] h-[280px] rounded-2xl m-3.5 shadow-[0_5px_26px_5px_rgba(0,0,0,0.17)] flex flex-col justify-center items-center bg-[#FFFFFF]">
          <div>
            <img src="img/undraw_Design_process_re_0dhf 1.png" alt="frontend" />
          </div>

          <h3 className="font-[600] text-2xl leading-[38px] tracking-[.055em]">
            Database
            {/* <span className="font-[400]">Developer</span> */}
          </h3>
          <p className="font-[400] text-lg leading-[27px] tracking-[.055em]">
            (MongoDB, SQL )
          </p>
